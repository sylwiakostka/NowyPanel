...
public class FiltrPayByCardAirport {
    WebDriver driver;
    ...
    public void initAndLogIn() {
        ...
        client = "Juliusz Kwaśny";
        commnent = "walizka i 2 osoby towarzyszące";
        buttonText = "Płatność kartą";
    ...
    @Test
    public void makeOrderPayByCard() throws InterruptedException {
        ...
        WebElement lotniskoAddress = waitDriver.until(ExpectedConditions.presenceOfElementLocated(By.partialLinkText("Żwirki i Wigury 1, Warszawa")));
        ...
        WebElement platnoscKartaButton = fluentWait.until(new Function<WebDriver, WebElement>() {
            public WebElement apply(WebDriver driver) {
                return driver.findElement(By.xpath("//div[@uib-modal-transclude]//input[@ng-model='filters.cardPayment.enabled']"));
            }
        });
        Thread.sleep(4000);
        waitDriver.until(ExpectedConditions.visibilityOf(platnoscKartaButton));
        platnoscKartaButton.click();
        ...
        WebElement filtrKartaButton = driver.findElement(By.xpath("//a[@class='btn btn-default ng-binding ng-scope']"));
        String filtrKartaButtonText = filtrKartaButton.getText();
        Assertions.assertEquals(buttonText, filtrKartaButtonText);
