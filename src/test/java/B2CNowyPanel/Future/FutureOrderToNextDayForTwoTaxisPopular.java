...
public class FutureOrderToNextDayForTwoTaxisPopular {
    WebDriver driver;
    ...
    public void initAndLogIn() {
        ...
        driver.get(url);
        startAddress = "Wiejska 2, Warszawa";
    ...
    public void makeFutureOrder() {
        ...
        WebElement wiejskaAdress = waitDriver.until(ExpectedConditions.presenceOfElementLocated(By.partialLinkText("Wiejska 2, Warszawa")));
        wiejskaAdress.click();
